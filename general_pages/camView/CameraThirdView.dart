...
class CameraThirdView extends StatefulWidget {
  const CameraThirdView({Key? key}) : super(key: key); // Fix the constructor

  @override
  State<CameraThirdView> createState() => _CameraSecondViewState();
}

class _CameraSecondViewState extends State<CameraThirdView> {
  File? _image;
  String? _imageURL;
  bool check = true;
                    ...
                    onTap: () {
                      setState(() {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CameraSecondView(),
                          ),
