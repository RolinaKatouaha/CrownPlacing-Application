...
import 'package:crown_placing/general_pages/camView/CameraLastView.dart';
...
class CameraFourthView extends StatefulWidget {
  const CameraFourthView({Key? key}) : super(key: key); // Fix the constructor

  @override
  State<CameraFourthView> createState() => _CameraSecondViewState();
}

class _CameraSecondViewState extends State<CameraFourthView> {
  File? _image;
  String? _imageURL;
  bool check = true;
                    ...
                    onTap: () {
                      setState(() {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CameraLastView(),
                          ),
                        ); // Update the current view to 1
                      });
                    },
